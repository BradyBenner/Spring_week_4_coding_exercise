...
public class DefaultJeepOrderDao implements JeepOrderDao {
	  ...
	  @Override
		public Order saveOrder(Customer customer, Jeep jeep, Color color, Engine engine, Tire tire, List<Option> options,
				BigDecimal price) {
	  ...
	  private void saveOption(Option option, long orderPK) {
		SqlParams sqlParams = generateInsertSql(option, orderPK);
